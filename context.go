...
// Tn returns the translation associated to key, for the client locale. If the translation defines plural forms (zero, one, other), it uses the most apropriate. All TnPlaceholder in the translation are replaced with number n. When translation is not found, an empty string is returned.
